<section class="col-lg-10">
    <form class="form-horizontal" id="blog-article" name="article" method="post" action="/admin/tour/store" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-4">
                <input class="form-control" type="text" id="venue" name="venue" value="" required>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-4">
                <div class="col-lg-2">
                    <input type="checkbox" name="is_available" value="1" checked data-toggle="toggle" data-on="yes" data-off="no" data-size="small">
                </div>
            </div>
        </div>
